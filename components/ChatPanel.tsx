...
const ChatPanel: React.FC<ChatPanelProps> = ({
  ...
  return (
    <div className="flex flex-col bg-white dark:bg-slate-800 h-full">
      <div className="flex-grow p-4 sm:p-6 flex flex-col overflow-hidden">
      ...
      <div className="p-4 sm:p-6 border-t border-slate-200 dark:border-slate-700 bg-white/50 backdrop-blur-sm dark:bg-slate-800/50 flex-shrink-0">
